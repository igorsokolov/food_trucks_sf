defmodule FoodTrucksMapWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FoodTrucksMapWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FoodTrucksMapWeb.Gettext, "errors", msg, opts)
    end
  end
